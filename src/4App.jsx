...
// Publicaciones pendientes (simulación)
const PENDING_PUBLICATIONS = [
  { id: 101, user: { name: "Ana_Moda", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Ana" }, image: "https://images.unsplash.com/photo-1539008835657-9e8e9680c956?auto=format&fit=crop&q=80&w=600", title: "Vestido Floral Primavera", price: 45000, size: "M", category: "vestidos", condition: "Ropa nueva sin etiqueta", gender: "Femenino", ageGroup: "Adulto", cuotas: "6 cuotas sin interés", comision: "12%", status: { iniciada: true, verificada: false, aprobada: false, publicada: false } },
  { id: 102, user: { name: "Carlos_Sport", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Carlos" }, image: "https://images.unsplash.com/photo-1608231387042-66d1773070a5?auto=format&fit=crop&q=80&w=600", title: "Zapatillas Running Pro", price: 89000, size: "42", category: "calzado", condition: "Ropa nueva con etiqueta", gender: "Masculino", ageGroup: "Adulto", cuotas: "12 cuotas sin interés", comision: "15%", status: { iniciada: true, verificada: true, aprobada: false, publicada: false } }
];
                      ...
                      <div className="flex-1">
                        <div className="flex items-start justify-between mb-2">
                          ...
                          <div className="flex gap-2">
                            ...
                            <button 
                              onClick={() => {
                                const newTitle = prompt('Editar título:', product.title);
                                if (newTitle) handleEditProduct(product.id, { title: newTitle });
                              }}
