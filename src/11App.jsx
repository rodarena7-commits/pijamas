...
export default function App() {
  ...
  const handlePayment = () => {
    ...
    window.open("https://link.mercadopago.com.ar/masroma", "_blank");
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <div className="mb-4 text-sm">
                    <span className="text-slate-500">Neto a cobrar: </span>
                    <span className="font-bold text-emerald-600">${(selectedProduct.price - selectedProduct.price * COMISION).toLocaleString()}</span>
                    <span className="text-xs text-slate-400 ml-1">(19% comisión)</span>
                  </div>
          ...
          <div className="relative bg-white w-full max-w-4xl rounded-[2.5rem] p-8 shadow-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div>
              <h3 className="text-lg font-bold mb-4 flex items-center gap-2">
                <Clock size={18} /> 
                {selectedTab === 'pendientes' ? 'Publicaciones Pendientes' : 'Publicaciones Publicadas'}
              </h3>
              <div className="space-y-6">
                {(selectedTab === 'pendientes' ? pendingProducts : products).map(product => (
                      ...
                      <div className="flex-1">
                        ...
                        <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-3">
                          <div className="bg-slate-50 p-2 rounded-xl">
                            ...
                            <p className="text-[6px] text-slate-400">Neto: ${(product.price - product.price * COMISION).toLocaleString()}</p>
                          </div>
                          <div className="bg-slate-50 p-2 rounded-xl">
              ...
              <form onSubmit={handleUpdateProduct} className="space-y-6">
                ...
                <div className="bg-slate-50 p-4 rounded-2xl">
                  <p className="text-sm text-slate-600">
                    ...
                    <span className="text-xs ml-2">(19% comisión)</span>
                  </p>
                </div>
