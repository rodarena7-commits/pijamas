...
// Lista inicial de usuarios autorizados para publicar (solo el administrador podrá añadir más desde el panel)
      ...
      <footer className="bg-white border-t border-slate-100 py-6 mt-8">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-[10px] text-slate-400 mt-4">
            © {new Date().getFullYear()} Pijamas. Todos los derechos reservados.
          </p>
        </div>
      </footer>
