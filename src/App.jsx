...
const CATEGORY_FILTERS = [
  { id: 'pijamas', name: 'Pijamas', image: '/pijamas-icon.png' },
  { id: 'pantuflas', name: 'Pantuflas', image: '/pantuflas-icon.png' },
  { id: 'accesorios', name: 'Accesorios', image: '/accesorios-icon.png' }
];

// CATEGORÍAS para la publicación de productos (sigue siendo la lista completa, pero el filtro principal solo mostrará las 3)
const CATEGORIES = [
  { id: 'pijamas', name: 'Pijamas', image: '/pijamas-icon.png' },
  { id: 'pantuflas', name: 'Pantuflas', image: '/pantuflas-icon.png' },
  { id: 'accesorios', name: 'Accesorios', image: '/accesorios-icon.png' },
