...
const APP_ID = "pijamas"; // Identificador único para esta app
...
export default function App() {
  ...
  // Guardar estado del banner en localStorage cuando cambie
  useEffect(() => {
  ...
  const [selectedCategoryFilter, setSelectedCategoryFilter] = useState(null); // Para las 3 categorías principales
  ...
  useEffect(() => {
    ...
    const questionsUnsubscribe = onSnapshot(
      ...
      (snapshot) => {
        ...
        // Filtrar preguntas que pertenezcan a productos de esta app
  ...
  }, [user, products, pendingProducts]); // Dependencias necesarias para el filtro de preguntas
  ...
  const handleUpload = async (e) => {
    ...
    const productToAdd = {
      appId: APP_ID, // Identificador de esta app
      userId: user.uid,
      user: {
        name: user.name,
        avatar: user.avatar
  ...
  }, [products, searchTerm, selectedGender, selectedCategoryFilter]);
  ...
  return (
    <div className="min-h-screen bg-[#f8b195]/10 font-sans text-[#355c7d] pb-20 selection:bg-[#f67280]/30">
      ...
      {/* --- Banner SALE! Administrable (desactivado por defecto) --- */}
      {saleConfig.active && (
        <div
                  ...
                  <div className="mt-auto flex flex-col border-t border-[#c06c84]/20 pt-2 md:pt-4">
                    <div className="flex items-center justify-between">
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs md:text-xl font-black text-[#355c7d]">{"$" + product.price.toLocaleString()}</span>
                      </div>
                    ...
                    {user && product.userId === user.uid && (
                      <div className="mt-2 text-[8px] md:text-[10px] text-[#6c5b7b]">
                        ...
                        <span className="font-bold text-[#f67280]">{"$" + (product.price - product.price * COMISION).toLocaleString()}</span>
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    <span className="text-3xl font-black text-[#f67280]">{"$" + selectedProduct.price.toLocaleString()}</span>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    ...
                    <div className="bg-[#f8b195]/20 p-3 rounded-xl">
                      ...
                      <p className="font-bold text-[#355c7d]">
                    ...
                    <div className="bg-[#f8b195]/20 p-3 rounded-xl">
                      ...
                      <p className="font-bold text-[#355c7d]">{selectedProduct.gender}</p>
                    </div>
                  </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white w-full max-w-4xl rounded-[2.5rem] p-8 shadow-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="mb-12 p-6 bg-[#f8b195]/10 rounded-3xl">
              <h3 className="text-lg font-bold mb-4 flex items-center gap-2 text-[#355c7d]"><Tag size={18} /> Editar Banner SALE!</h3>
              <div className="space-y-4">
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-bold uppercase text-[#6c5b7b]">Precio/Promo (Ej: 50% OFF)</label>
                  <input
                    className="w-full bg-white border border-[#c06c84]/20 p-4 rounded-2xl outline-none focus:border-[#f67280] text-[#355c7d]"
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-bold uppercase text-[#6c5b7b]">Vigencia/Texto adicional</label>
                  <input
                    className="w-full bg-white border border-[#c06c84]/20 p-4 rounded-2xl outline-none focus:border-[#f67280] text-[#355c7d]"
                ...
                <div className="flex items-center gap-3 py-2">
                  <input
                    ...
                    className="w-5 h-5 accent-[#f67280]"
                  />
                  <span className="text-sm font-bold text-[#355c7d]">Banner Activo</span>
                </div>
              </div>
            </div>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-3">
                          <div className="bg-[#f8b195]/10 p-2 rounded-xl">
                            ...
                            <p className="font-black text-sm text-[#355c7d]">{"$" + product.price.toLocaleString()}</p>
                          </div>
                          <div className="bg-[#f8b195]/10 p-2 rounded-xl">
                            <span className="text-[8px] font-bold uppercase text-[#6c5b7b]">Comisión</span>
                            <p className="font-bold text-sm text-[#f67280]">{"$" + (product.price * COMISION).toLocaleString()}</p>
                          </div>
                          <div className="bg-[#f8b195]/10 p-2 rounded-xl">
                            <span className="text-[8px] font-bold uppercase text-[#6c5b7b]">Neto vendedor</span>
                            <p className="font-bold text-sm text-[#355c7d]">{"$" + (product.price - product.price * COMISION).toLocaleString()}</p>
                          </div>
                          <div className="bg-[#f8b195]/10 p-2 rounded-xl">
                            <span className="text-[8px] font-bold uppercase text-[#6c5b7b]">
                              {product.category === 'calzado' ? 'Talle (EUR)' : 'Talle'}
                            </span>
                            <p className="font-bold text-sm text-[#355c7d]">
            ...
            <div className="p-8 md:p-12">
              ...
              <form onSubmit={handleUpdateProduct} className="space-y-6">
                ...
                {(editingProduct.category === 'remeras' || editingProduct.category === 'camisas' || editingProduct.category === 'buzos' || editingProduct.category === 'vestidos' || editingProduct.category === 'camperas') && (
                  <div className="space-y-4">
                    <h4 className="font-bold text-sm text-[#355c7d]">Medidas parte superior (cm)</h4>
                    <div className="grid grid-cols-2 gap-4">
                      <input
                        type="number"
                ...
                {(editingProduct.category === 'pantalones' || editingProduct.category === 'jeans' || editingProduct.category === 'short') && (
                  <div className="space-y-4">
                    <h4 className="font-bold text-sm text-[#355c7d]">Medidas parte inferior (cm)</h4>
                    <div className="grid grid-cols-2 gap-4">
                      <input
                        type="number"
                        placeholder="Cintura"
      ...
      {/* --- Modal de Carga de Comprobante (Transferencia) con nuevo alias y titular --- */}
      {isReceiptModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
              ...
              {cart.map(item => (
                <div key={item.id} className="flex gap-4 group">
                  ...
                  <div className="flex-1 flex flex-col justify-between py-1">
                    ...
                    <div className="flex items-center justify-between mt-2">
                      <span className="text-sm font-black text-[#355c7d]">{"$" + item.price.toLocaleString()}</span>
